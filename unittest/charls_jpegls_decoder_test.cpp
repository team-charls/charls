...
public:
    ...
    TEST_METHOD(read_header_from_zero_size_buffer)
    {
        auto* decoder{charls_jpegls_decoder_create()};
    ...
    TEST_METHOD(decode_to_zero_size_buffer)
    {
        const auto decoder{get_initialized_decoder()};
