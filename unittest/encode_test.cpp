...
public:
    ...
    TEST_METHOD(encode_2_components_7_bit_interleave_none)
    {
    ...
    TEST_METHOD(encode_2_components_7_bit_interleave_line)
    {
        constexpr array data{byte{10}, byte{20}, byte{30}, byte{40}, byte{50}, byte{60}, byte{70}, byte{80}};
        encode({2, 2, 7, 2}, {data.cbegin(), data.cend()}, 47, interleave_mode::line);
    }

    TEST_METHOD(encode_2_components_7_bit_interleave_sample)
    {
        constexpr array data{byte{10}, byte{20}, byte{30}, byte{40}, byte{50}, byte{60}, byte{70}, byte{80}};
    ...
    TEST_METHOD(encode_2_components_15_bit_interleave_none)
    {
    ...
    TEST_METHOD(encode_2_components_15_bit_interleave_line)
    {
        constexpr array data{byte{10}, byte{1}, byte{20}, byte{1}, byte{30}, byte{1}, byte{40}, byte{1},
                             byte{50}, byte{1}, byte{60}, byte{1}, byte{70}, byte{1}, byte{80}, byte{1}};
    ...
    TEST_METHOD(encode_2_components_15_bit_interleave_sample)
    {
        constexpr array data{byte{10}, byte{1}, byte{20}, byte{1}, byte{30}, byte{1}, byte{40}, byte{1},
                             byte{50}, byte{1}, byte{60}, byte{1}, byte{70}, byte{1}, byte{80}, byte{1}};
